...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 12, 2021 lúc 04:36 AM
...
(92, 123, 'A204', 'A104', 'muốn chuyển', 'chưa duyệt', NULL, '2020-12-04', 1);
...
(91, 161250533333, 'C101', 'NV1', '2019-12-22', '2019-12-22', 'chưa duyệt'),
(92, 123, 'A104', 'NV1', '2020-12-02', '2020-12-04', 'chưa duyệt');
...
(17, 'C101', '282000', '150500', 11, 'chưa thu');
...
(123, 'Nguyễn Trung Hiếu ', 'Nam', '2001-07-15', '286 mai đăng chơn', 384375266, '123456'),
(157, 'Nguyễn Hiếu', 'nam', '2001-07-11', 'Đà Nẵng', 12381241, '123456'),
...
(69, 123, 'NV1', 'Thông Báo Đăng Ký Phòng Ký Túc Xá', 'Bạn đã đăng ký thành công ! Phòng : A104. Vui lòng lên ký túc xá để thanh toán tiền phòng và nhận phòng trước ngày 2020-12-5 0:22:19. Nếu không lên nhận phòng hệ thống sẽ hủy phòng của bạn và thêm bạn vào danh sách Xấu. Xin Cảm ơn !!!', 'đăng ký', '2020-12-02');
...
--
ALTER TABLE `chitietdangky`
  MODIFY `MaDK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;
...
--
ALTER TABLE `thongbao`
  MODIFY `MaTB` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
